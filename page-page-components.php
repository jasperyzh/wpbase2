...
<main id="main" class="site-main">
    ...
    <div class="jumbotron bg-body-tertiary my-5 py-5 position-relative overflow-hidden">
        ...
        <img class="jumbotron__img" src="/images/Sorang Sorang (Ticket)-ZH_01350.jpg" alt="" />
    </div>
        ...
        <div class="row row-cols-1 row-cols-md-2 g-3">
            ...
            <div class="col">
                <div class="card">
                    <div class="row g-0">
                        <div class="col-4">
                            <img src="/placeholder.svg" class="rounded" />
                        </div>
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-lg-7">
                <img class="object-fit-cover w-100" src="/placeholder.svg" alt="--image" style="aspect-ratio: 16/9" />
            </div>
    ...
    <div class="container text-bg-primary rounded p-lg-5 text-center">
        ...
        <div class="row row-cols-1 row-cols-sm-3 g-4">
            ...
            [0, 1, 2].map((item) => (
            <div class="col d-flex flex-column gap-2">
                <i class="bi bi-airplane-fill h3" />
        ...
        <div class="row row-cols-1 row-cols-lg-3 g-3 mb-4">
            ...
            <div class="col">
                <div class="card text-bg-primary text-center p-4">
                    <div class="card-body">
                        <i class="bi bi-airplane-fill h3 mb-2" />
                        <h3 class="h5">
        ...
        <div class="row row-cols-1 row-cols-lg-3 g-3 mb-4">
            ...
            <div class="col">
                <div class="card text-center shadow">
                    <div class="card-body">
                        <img src="/placeholder.svg" width="108" alt="" class="mb-2" />
                        <h3 class="h6">Partner #{item}</h3>
                    </div>
                </div>
            </div>
            ))
    ...
    <div class="container text-bg-primary rounded px-lg-5">
        <div class="row row-cols-1 row-cols-md-3 gx-5 row-gap-3 py-3 py-lg-5">
            {
            [0, 1, 2].map((item) => (
            <div class:list={["col", item==1 ? "border-left-right-light" : "" ]}>
                <h3 class="h5">
                    <span class="d-block h1 mb-0">75</span>Orders received
                </h3>
                <p class="card-text">
                    Organically grow th eholistic world view of disruptive innovation
        ...
        <div class="row justify-content-center">
            ...
            <div class="container rounded shadow-sm px-lg-5 glass">
                <div class="row row-cols-1 row-cols-md-3 gx-5 row-gap-3 py-3 py-lg-5">
                    {
                    [0, 1, 2].map((item) => (
                    <div class:list={["col", item==1 ? "border-left-right" : "" ]}>
                        <span class="d-block h1 mb-2">{item}</span>
                        <h3 class="h5">Automated testing and professional support</h3>
                        <p class="card-text fs-6">
                            Organically grow th eholistic world view of disruptive
